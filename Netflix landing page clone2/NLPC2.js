...
document.getElementById("signin").onclick=function(){
    location.href="https://www.netflix.com/in/login";
}
document.getElementById("getstarted").onclick=function(){
    location.href="https://www.netflix.com/signup/registration?locale=en-IN";
}
document.getElementById("getstarted2").onclick=function(){
    location.href="https://www.netflix.com/signup/registration?locale=en-IN";
}
